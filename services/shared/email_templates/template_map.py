...
_TEMPLATE_BY_TYPE: dict[str, str] = {
    ...
    NotificationType.EVALUATION_RECEIVED_HUMAN.value: "evaluation_received.html",
    NotificationType.EVALUATION_RECEIVED_IMMEDIATE.value: "evaluation_received.html",
    NotificationType.EVALUATION_RECEIVED_BATCH.value: "evaluation_received.html",
