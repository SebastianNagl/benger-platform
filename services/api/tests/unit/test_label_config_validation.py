...
class TestAngabeValidation:
    """Test Angabe field type validation"""

    def test_valid_angabe_with_labels(self):
        """Angabe field with Label children should be accepted"""
        xml = """<View>
  ...
  <Angabe name="angabe" value="$sachverhalt" toName="sachverhalt">
    ...
    def test_valid_angabe_with_many_labels(self):
        """Angabe field with all six default labels should be accepted"""
        xml = """<View>
  <Text name="sachverhalt" value="$sachverhalt"/>
  <Angabe name="angabe" value="$sachverhalt" toName="sachverhalt"
    ...
    def test_valid_angabe_without_labels(self):
        """Angabe field without Label children should still be valid"""
        xml = """<View>
  <Text name="sachverhalt" value="$sachverhalt"/>
  <Angabe name="angabe" value="$sachverhalt" toName="sachverhalt"/>
</View>"""
    ...
    def test_angabe_missing_name_rejected(self):
        """Angabe without name attribute should be rejected"""
        xml = """<View>
  <Text name="sachverhalt" value="$sachverhalt"/>
  <Angabe value="$sachverhalt" toName="sachverhalt">
    <Label value="Wichtig"/>
  </Angabe>
</View>"""
        is_valid, errors = LabelConfigValidator.validate(xml)
    ...
    def test_angabe_duplicate_name_rejected(self):
        """Angabe with duplicate field name should be rejected"""
        xml = """<View>
  <Text name="sachverhalt" value="$sachverhalt"/>
  <Angabe name="sachverhalt" value="$sachverhalt" toName="sachverhalt">
    <Label value="Wichtig"/>
  </Angabe>
</View>"""
        is_valid, errors = LabelConfigValidator.validate(xml)
    ...
    def test_angabe_in_gutachten_template(self):
        """Full Gutachten template with Angabe should be accepted"""
        xml = """<View>
  <Header value="Sachverhalt"/>
  <Text name="sachverhalt" value="$sachverhalt"/>
  ...
  <Loesung name="loesung" toName="sachverhalt" linkedTo="gliederung"/>
</View>"""
        is_valid, errors = LabelConfigValidator.validate(xml)
        assert is_valid is True
        assert len(errors) == 0
