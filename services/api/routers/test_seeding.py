...
def _build_parsed_annotation(output: str, gen_data: Dict[str, Any]) -> list:
    ...
    if annotation_type in ("Loesung", "Gliederung", "markdown"):
        return [{"from_name": default_from, "to_name": default_to, "type": annotation_type or "Loesung", "value": {"markdown": output}}]
