...
dependency. It loads the project, runs the existing
...
class ProjectAccess:
    ...
    __slots__ = ("project", "user", "tier")

    def __init__(self, project: Project, user, tier: str = "full"):
...
def require_project_access(
    ...
    *,
    ...
    async def _dependency(
        ...
        return ProjectAccess(project=project, user=current_user, tier=tier)
