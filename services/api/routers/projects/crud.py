...
async def update_project(
    ...
    # If disabling time limit, also disable strict timer
    if "annotation_time_limit_enabled" in update_data and not update_data["annotation_time_limit_enabled"]:
        update_data["strict_timer_enabled"] = False
