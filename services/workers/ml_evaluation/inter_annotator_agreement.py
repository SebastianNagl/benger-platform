...
def cohens_kappa(
    ...
    """Cohen's Kappa for two raters. Thin wrapper over bg_statistics.agreement."""
    from bg_statistics import cohens_kappa as _cohens_kappa

    return _cohens_kappa(rater1, rater2, weights=weights)
...
def fleiss_kappa(
    ...
    """Fleiss' Kappa for ≥2 raters. Thin wrapper over bg_statistics.agreement."""
    from bg_statistics import fleiss_kappa as _fleiss_kappa

    return _fleiss_kappa(ratings_matrix, categories=categories)
