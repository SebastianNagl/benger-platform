...
export function HeroSection() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- Intentional: host-dependent value resolved after mount
    setStudentSiteUrl(getSisterHostUrl())
  }, [])
    ...
    <div className="relative isolate px-4 pt-8 sm:px-6 sm:pt-14 lg:px-8">
      ...
      <div className="mx-auto max-w-5xl py-12 sm:py-16 md:py-24 lg:py-32">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl md:text-6xl lg:text-7xl dark:text-white">
            <span className="block">{t('landing.heroTitle.prefix')}</span>
          ...
          <p className="mx-auto mt-8 max-w-4xl text-lg leading-8 text-zinc-600 sm:mt-12 sm:text-xl sm:leading-9 lg:text-2xl lg:leading-10 dark:text-zinc-400">
