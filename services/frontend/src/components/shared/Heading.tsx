...
function Anchor({
  ...
  return (
    ...
    >
      {inView && (
        <div className="absolute -ml-(--width) mt-1 hidden w-(--width) opacity-0 transition [--width:calc(2.625rem+0.5px+50%-min(50%,calc(var(--container-lg)+2rem)))] group-hover:opacity-100 group-focus:opacity-100 md:block lg:z-50 2xl:[--width:2.5rem]">
