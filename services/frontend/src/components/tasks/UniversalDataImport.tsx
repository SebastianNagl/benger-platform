      ...
      <CardContent>
        ...
        <details className="mt-6">
          ...
          <pre className="mt-2 overflow-auto rounded bg-gray-50 p-4 text-xs">
            {`[
  {
    "fallnummer": "2025-BGH-001",
    "sachverhalt": "Der Kläger fordert...",
    "rechtsfrage": "Liegt ein Anspruch vor?",
    "urteil": "Anspruch besteht",
    "rechtsgebiet": "Zivilrecht"
        ...
        <details className="mt-2">
          ...
          <pre className="mt-2 overflow-auto rounded bg-gray-50 p-4 text-xs">
            {`fallnummer,sachverhalt,rechtsfrage,urteil,rechtsgebiet
2025-BGH-001,"Der Kläger fordert...","Liegt ein Anspruch vor?","Anspruch besteht","Zivilrecht"
2025-BGH-002,"Die Beklagte wendet ein...","Ist die Klage zulässig?","Klage abgewiesen","Zivilrecht"`}
          </pre>
        </details>
      </CardContent>
    </Card>
