  ...
  useI18n: () => ({
    t: (key: string, params?: any) => {
      const translations: Record<string, string> = {
        ...
        'projects.importModal.description': 'Import data to create tasks',
        'projects.importModal.fieldRequirements': 'Field Requirements',
        'projects.importModal.fieldRequirementsDescription': 'Required fields',
        'projects.importModal.missingFieldsWarning': 'Missing fields warning',
        ...
        'projects.importModal.dropFilesHere': 'Drop files here',
        'projects.importModal.supportedFormats': 'JSON, CSV, TSV, TXT',
        'projects.importModal.chooseFiles': 'Choose Files',
        'projects.importModal.pasteYourData': 'Paste your data',
        'projects.importModal.pastePlaceholder': 'Paste data here...',
        'projects.importModal.csvTip': 'CSV tip',
        'projects.importModal.cloudComingSoon': 'Coming soon',
        'projects.importModal.validationError': 'Validation Error',
        'projects.importModal.validationErrorDescription': 'Fields do not match',
        'projects.importModal.importAnyway': 'Import Anyway',
        'projects.importModal.orUseFieldMapping': 'Or use mapping',
