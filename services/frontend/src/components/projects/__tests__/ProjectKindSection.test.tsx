...
const expand = () =>
  fireEvent.click(screen.getByRole('button', { name: /Projekttyp/ }))
...
describe('ProjectKindSection', () => {
  it('shows the picked type as the collapsed badge and the radio when expanded', () => {
    ...
    expand()
    expect(screen.getByTestId('project-kind-exam')).toHaveAttribute(
      'aria-checked',
      'true',
    )
