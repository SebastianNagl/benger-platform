  ...
  useI18n: () => ({
    t: (key: string, params?: any) => {
      const translations: Record<string, string> = {
        ...
        'projects.importModal.description': 'Import data to create tasks in your project',
        'projects.importModal.fieldRequirements': 'Data Field Requirements',
        'projects.importModal.fieldRequirementsDescription': 'Your template requires these data fields',
        'projects.importModal.missingFieldsWarning': 'Missing required fields will cause validation errors',
        'projects.importModal.uploadFiles': 'Upload Files',
        'projects.importModal.pasteData': 'Paste Data',
        'projects.importModal.cloudStorage': 'Cloud Storage',
        'projects.importModal.dropFilesHere': 'Drop files here or click to upload',
        'projects.importModal.supportedFormats': 'Supports JSON, CSV, TSV, and plain text files',
        'projects.importModal.chooseFiles': 'Choose Files',
        'projects.importModal.pasteYourData': 'Paste your data',
        'projects.importModal.pastePlaceholder': 'Paste JSON, CSV, or plain text data...',
        'projects.importModal.csvTip': 'Tip: For CSV data, include a header row with column names',
        'projects.importModal.cloudComingSoon': 'Cloud storage integration coming soon',
        'projects.importModal.validationError': 'Import Validation Error',
        'projects.importModal.validationErrorDescription': 'The imported data fields do not match the template requirements',
        'projects.importModal.importAnyway': 'Import Anyway',
        'projects.importModal.orUseFieldMapping': 'Or use field mapping below',
