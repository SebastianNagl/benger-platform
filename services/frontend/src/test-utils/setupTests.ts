...
jest.mock('@/contexts/I18nContext', () => {
  const translations: Record<string, string> = {
    ...
    'labeling.next': 'Next',
    'labeling.legalMarkdown.savedToDb': 'Changes saved to database',
    'labeling.legalMarkdown.saveFailed': 'Save failed',
    'labeling.legalMarkdown.saved': 'Changes saved',
    'labeling.legalMarkdown.previousField': 'Previous field (Alt+Left)',
    'labeling.legalMarkdown.previousFieldAria': 'Navigate to previous field',
    'labeling.legalMarkdown.nextField': 'Next field (Alt+Right)',
    'labeling.legalMarkdown.nextFieldAria': 'Navigate to next field',
    'labeling.legalMarkdown.closeEscape': 'Close (Escape)',
    'labeling.legalMarkdown.closeModal': 'Close modal',
    'labeling.legalMarkdown.placeholder': 'Enter your content...',
    'labeling.legalMarkdown.toNavigate': 'to navigate',
    'labeling.legalMarkdown.toSave': 'to save',
    'labeling.legalMarkdown.toCancel': 'to cancel',
    'labeling.legalMarkdown.cancel': 'Cancel',
    'labeling.legalMarkdown.save': 'Save',
