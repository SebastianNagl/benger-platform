...
describe('DataProtectionPage', () => {
  ...
  it('should render all section headings', () => {
    render(<DataProtectionPage />)
    expect(
      screen.getByText('legal.dataProtection.overview'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.controller'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.dataProcessing'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.accountData'),
    ).toBeInTheDocument()
    expect(
    ...
    expect(
      screen.getByText('legal.dataProtection.dataRetention'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.yourRights'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.security'),
    ).toBeInTheDocument()
  ...
  it('should render section text content', () => {
    render(<DataProtectionPage />)
    expect(
      screen.getByText('legal.dataProtection.overviewText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.accountDataText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.usageDataText'),
    ).toBeInTheDocument()
    expect(
    ...
    expect(
      screen.getByText('legal.dataProtection.dataSharingText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.dataRetentionText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.rightsText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.securityText'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('legal.dataProtection.contactText'),
    ).toBeInTheDocument()
  })
  ...
  it('should format controller info with line breaks', () => {
    ...
    expect(
      screen.getByText('legal.dataProtection.controllerInfo'),
    ).toBeInTheDocument()
  })
})
