...
async function proxyRequest(
  ...
  try {
    ...
    // Bulk export/import bytes no longer transit this proxy — exports download
    // via a presigned object-storage URL (302 redirect) and imports upload
    // straight to object storage — so the global fetch handles every path.
